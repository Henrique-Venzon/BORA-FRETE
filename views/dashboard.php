                    ...
                    <?php foreach ($veiculos as $veiculo): ?>
                        <div class="vehicle-card">
                            ...
                            <div class="vehicle-actions">
                                <button class="btn-icon btn-edit" onclick="editarVeiculo(<?php echo $veiculo['id']; ?>)" title="Editar">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M3 17.25V21H6.75L17.81 9.94L14.06 6.19L3 17.25ZM20.71 7.04C21.1 6.65 21.1 6.02 20.71 5.63L18.37 3.29C17.98 2.9 17.35 2.9 16.96 3.29L15.13 5.12L18.88 8.87L20.71 7.04Z" fill="currentColor"/>
                                    </svg>
                                </button>
                                <button class="btn-icon btn-delete" onclick="deletarVeiculo(<?php echo $veiculo['id']; ?>)" title="Deletar">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function editarVeiculo(id) {
    window.location.href = BASE_URL + 'views/editar-veiculo.php?id=' + id;
}
...
function deletarVeiculo(id) {
    ...
    form.method = 'POST';
    form.action = BASE_URL + 'processamento/deletar_veiculo.php';
    form.innerHTML = `<input type="hidden" name="veiculo_id" value="${id}">`;
